...
public class BleService extends Service {
    ...
    //注意下面这些UUID，一般由蓝牙硬件开发者提供，或者自己通过其它方式找到这些UUID，如果连接失败，或者连接上又断开，可以考虑这些UUID是否正确
    // 服务标识
    private final UUID SERVICE_UUID = UUID.fromString("03B80E5A-EDE8-4B33-A751-6CE34EC4C700");
    // 特征标识（读取数据）
    private final UUID CHARACTERISTIC_READ_UUID = UUID.fromString("7772e5db-3868-4112-a1a9-f2669d106bf3");
    // 特征标识（发送数据）
